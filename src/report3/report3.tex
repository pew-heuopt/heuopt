...
\caption{This table shows the results of our algorithm using when we
  flipped the order of the deterministic neighborhoods.}
...
\caption{This table shows the results of our algorithm where we
  flipped the order of the stochastic neighborhoods used for shaking.}
...
\caption{This table shows the runtime of our algorithm (det-order).}
\label{tab:Timing}
\end{table}
...
\caption{This table shows the runtime of our algorithm (stoch-order).}
\label{tab:Timing}
\end{table}
