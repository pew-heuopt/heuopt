#ifndef _NEIGHBORHOOD_NODE_EDGE_MOVE_H_
#define _NEIGHBORHOOD_NODE_EDGE_MOVE_H_


#include "kpmp_solution.h"

class const_neighborhood_node_edge_move_iterator ;
...
public:
    const_neighborhood_node_edge_move_iterator( const solution & init_solution );

    virtual solution operator*() const;

    const_neighborhood_node_edge_move_iterator & operator++() { increment(); return *this; };

    bool operator==( const const_neighborhood_node_edge_move_iterator & rhs ) const;
    bool operator!=( const const_neighborhood_node_edge_move_iterator & rhs ) const;
...
#endif // _NEIGHBORHOOD_NODE_EDGE_MOVE_H_
